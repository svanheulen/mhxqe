...
function linkIcon(checkbox, select, buffer, offset) {
    var item = new Uint8Array(buffer, offset, 1);
    ...
    select.value = (item[0] < 120) ? item[0] : (item[0] - 120);
...
rArchive.prototype.addFile = function (file_type) {
    switch (parseInt(file_type, 10)) {
        case rQuestData.prototype.file_type:
            this.files.push(new rQuestData(null, "loc\\quest\\questData\\questData_1010001"));
            break;
        case rGUIMessage.prototype.file_type:
            this.files.push(new rGUIMessage(null, "eng\\quest\\questData\\questData_1010001_eng"));
            break;
        case rSetEmMain.prototype.file_type:
...
var rQuestData = function (raw_data, file_name) {
    ...
    this.quests = [];
    if (raw_data == null) {
        var raw_data = new ArrayBuffer(0x640);
        var view = new DataView(raw_data);
        ...
        view.setUint32(0x174, rGUIMessage.prototype.file_type, true);
        view.setUint32(0x1b8, rGUIMessage.prototype.file_type, true);
        view.setUint32(0x1fc, rGUIMessage.prototype.file_type, true);
        view.setUint32(0x240, rGUIMessage.prototype.file_type, true);
        view.setUint32(0x284, rSetEmMain.prototype.file_type, true);
        view.setUint32(0x2c8, rSetEmMain.prototype.file_type, true);
        view.setUint32(0x30c, rSetEmMain.prototype.file_type, true);
        view.setUint32(0x350, rSetEmMain.prototype.file_type, true);
        view.setUint32(0x394, rSetEmMain.prototype.file_type, true);
        view.setUint32(0x3d8, rEmSetList.prototype.file_type, true);
        view.setUint32(0x41C, rEmSetList.prototype.file_type, true);
        view.setUint32(0x460, rEmSetList.prototype.file_type, true);
        view.setUint32(0x4a4, rRem.prototype.file_type, true);
        view.setUint32(0x4e8, rRem.prototype.file_type, true);
        view.setUint32(0x52c, rRem.prototype.file_type, true);
        view.setUint32(0x570, rRem.prototype.file_type, true);
        view.setUint32(0x5b4, rRem.prototype.file_type, true);
        view.setUint32(0x5f8, rSupplyList.prototype.file_type, true);
    ...
    for (var i = 0; i < count; i++) {
        var offset = i * 0x640 + 8;
        this.quests.push(raw_data.slice(offset, offset + 0x640));
    }
}
...
rQuestData.prototype.getRaw = function () {
    ...
    for (var i = 0; i < this.quests.length; i++) {
        view = new Uint8Array(buffer, 8 + i * 0x640);
...
rQuestData.prototype.loadFile = function () {
    ...
    linkIcon(document.getElementById("mIcon_1_hyper"), document.getElementById("mIcon_1"), this.quests[0], 0x127);
    linkIcon(document.getElementById("mIcon_2_hyper"), document.getElementById("mIcon_2"), this.quests[0], 0x128);
    linkIcon(document.getElementById("mIcon_3_hyper"), document.getElementById("mIcon_3"), this.quests[0], 0x129);
    linkIcon(document.getElementById("mIcon_4_hyper"), document.getElementById("mIcon_4"), this.quests[0], 0x12a);
    linkIcon(document.getElementById("mIcon_5_hyper"), document.getElementById("mIcon_5"), this.quests[0], 0x12b);
    linkInput(document.getElementById("mProgNo"), "int", this.quests[0], 0x12c);
    linkInput(document.getElementById("mMessage_eng_type"), "int", this.quests[0], 0x130);
    linkInput(document.getElementById("mMessage_eng_name"), "string", this.quests[0], 0x134, 0x40);
    linkInput(document.getElementById("mMessage_fre_type"), "int", this.quests[0], 0x174);
    linkInput(document.getElementById("mMessage_fre_name"), "string", this.quests[0], 0x178, 0x40);
    linkInput(document.getElementById("mMessage_ger_type"), "int", this.quests[0], 0x1b8);
    linkInput(document.getElementById("mMessage_ger_name"), "string", this.quests[0], 0x1bc, 0x40);
    linkInput(document.getElementById("mMessage_ita_type"), "int", this.quests[0], 0x1fc);
    linkInput(document.getElementById("mMessage_ita_name"), "string", this.quests[0], 0x200, 0x40);
    linkInput(document.getElementById("mMessage_spa_type"), "int", this.quests[0], 0x240);
    linkInput(document.getElementById("mMessage_spa_name"), "string", this.quests[0], 0x244, 0x40);
    linkInput(document.getElementById("mBossSetRes_1_type"), "int", this.quests[0], 0x284);
    linkInput(document.getElementById("mBossSetRes_1_name"), "string", this.quests[0], 0x288, 0x40);
    linkInput(document.getElementById("mBossSetRes_2_type"), "int", this.quests[0], 0x2c8);
    linkInput(document.getElementById("mBossSetRes_2_name"), "string", this.quests[0], 0x2cc, 0x40);
    linkInput(document.getElementById("mBossSetRes_3_type"), "int", this.quests[0], 0x30c);
    linkInput(document.getElementById("mBossSetRes_3_name"), "string", this.quests[0], 0x310, 0x40);
    linkInput(document.getElementById("mBossSetRes_4_type"), "int", this.quests[0], 0x350);
    linkInput(document.getElementById("mBossSetRes_4_name"), "string", this.quests[0], 0x354, 0x40);
    linkInput(document.getElementById("mBossSetRes_5_type"), "int", this.quests[0], 0x394);
    linkInput(document.getElementById("mBossSetRes_5_name"), "string", this.quests[0], 0x398, 0x40);
    linkInput(document.getElementById("mEmSetListRes_1_type"), "int", this.quests[0], 0x3d8);
    linkInput(document.getElementById("mEmSetListRes_1_name"), "string", this.quests[0], 0x3dc, 0x40);
    linkInput(document.getElementById("mEmSetListRes_2_type"), "int", this.quests[0], 0x41c);
    linkInput(document.getElementById("mEmSetListRes_2_name"), "string", this.quests[0], 0x420, 0x40);
    linkInput(document.getElementById("mEmSetListRes_3_type"), "int", this.quests[0], 0x460);
    linkInput(document.getElementById("mEmSetListRes_3_name"), "string", this.quests[0], 0x464, 0x40);
    linkInput(document.getElementById("mRemTbl_1_type"), "int", this.quests[0], 0x4a4);
    linkInput(document.getElementById("mRemTbl_1_name"), "string", this.quests[0], 0x4a8, 0x40);
    linkInput(document.getElementById("mRemTbl_2_type"), "int", this.quests[0], 0x4e8);
    linkInput(document.getElementById("mRemTbl_2_name"), "string", this.quests[0], 0x4ec, 0x40);
    linkInput(document.getElementById("mRemTbl_Add1_type"), "int", this.quests[0], 0x52c);
    linkInput(document.getElementById("mRemTbl_Add1_name"), "string", this.quests[0], 0x530, 0x40);
    linkInput(document.getElementById("mRemTbl_Add2_type"), "int", this.quests[0], 0x570);
    linkInput(document.getElementById("mRemTbl_Add2_name"), "string", this.quests[0], 0x574, 0x40);
    linkInput(document.getElementById("mRemTbl_Sub_type"), "int", this.quests[0], 0x5b4);
    linkInput(document.getElementById("mRemTbl_Sub_name"), "string", this.quests[0], 0x5b8, 0x40);
    linkInput(document.getElementById("mSuppTbl_type"), "int", this.quests[0], 0x5f8);
    linkInput(document.getElementById("mSuppTbl_name"), "string", this.quests[0], 0x5fc, 0x40);
    linkInput(document.getElementById("mExtraTicketNum"), "int", this.quests[0], 0x63c);
...
window.onload = function () {
    ...
    fillSelect(document.getElementById("mMessage_eng_type"), file_type_list);
    fillSelect(document.getElementById("mMessage_fre_type"), file_type_list);
    fillSelect(document.getElementById("mMessage_ger_type"), file_type_list);
    fillSelect(document.getElementById("mMessage_ita_type"), file_type_list);
    fillSelect(document.getElementById("mMessage_spa_type"), file_type_list);
